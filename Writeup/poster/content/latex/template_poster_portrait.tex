...
\co-authorlogos{
	\co-authorlogo[4cm]{Grey_16{-}9.pdf} % Use the optional parameter to specify a height for the logo
	\co-authorlogo[4cm]{Grey_16{-}9.pdf} % Use the optional parameter to specify a height for the logo
	\co-authorlogo{Grey_16{-}9.pdf} % Not specifying the optional parameter will make the logo the same height as the Imperial logo
}
