...
\postertitle{
	Title\\
	Short and snappy, with the main message
}

\posterauthors{
	Presenter: {\color{black}Mayuran Visakan}\\
	Supervisor: {\color{black}Adam Sykulski}
}
\color{ICLWhite}
...
\begin{multicols}{4} % Column 1
	...
	\begin{figure}[H] % [H] forces the figure to be output where it is defined in the code (it suppresses floating)
		\includegraphics[width=\linewidth]{../assets/images/Grey_4-3_Portrait.pdf} % Figure image % chktex 8
	...
	\begin{figure}[H] % [H] forces the figure to be output where it is defined in the code (it suppresses floating)
		\includegraphics[width=\linewidth]{../assets/images/Grey_16-9.pdf} % Figure image % chktex 8
	...
	\includegraphics[width=0.49\linewidth]{../assets/images/Grey_16-9.pdf}\hfill\includegraphics[width=0.49\linewidth]{../assets/images/Grey_16-9.pdf} % Side by side images % chktex 8
