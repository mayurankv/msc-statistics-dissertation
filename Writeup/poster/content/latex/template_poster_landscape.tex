...
\postertitle{Title\\ Short and snappy, with the main message}
...
\begin{multicols}{4} % Start the four-column layout
	...
	\begin{figure}[H] % [H] forces the figure to be output where it is defined in the code (it suppresses floating)
		\includegraphics[width=\linewidth]{Grey_4-3_Portrait.pdf} % Figure image % chktex 8
	...
	\begin{figure}[H] % [H] forces the figure to be output where it is defined in the code (it suppresses floating)
		\includegraphics[width=\linewidth]{Grey_16-9.pdf} % Figure image % chktex 8
	...
	\includegraphics[width=0.49\linewidth]{Grey_16-9.pdf}\hfill\includegraphics[width=0.49\linewidth]{Grey_16-9.pdf} % Side by side images % chktex 8
...
\begin{multicols}{4} % Start the three-column layout
	...
	\begin{figure}[H] % [H] forces the figure to be output where it is defined in the code (it suppresses floating)
		\includegraphics[width=0.495\textwidth]{Grey_4-3.pdf} % Figure image % chktex 8
